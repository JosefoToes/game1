...
function desbloqueacolor(colore){
	var colore = colore
	$('#blockeorojo, #blockeoazul, #blockeoamarillo, #blockeoverde').show();
	$('#blockeo' + colore + '').hide();
	turno = colore;
...
function findejuegoamarillo(){
	$('#scoreamarillo').html('$1,000,000');
	$('.myw').addClass('yafue').off();
	ganadores++ ;
	ganaamarillo = 1;
	cambiaturnoAmarillo();
	desbloqueacolor('verde');
...
$(document).ready(function(){
	...
	$('.correcta').click(function(){
		...
		if(turno == 'rojo' & scorenumrojo >= 1000000){
			...
			cambiaturnoAzul();
		}else if(turno == 'amarillo' & scorenumamarillo >= 1000000){
			ganaamarillo = 1;
			findejuegoamarillo();
		}else if(turno == 'amarillo' & scorenumamarillo <= 1000000){	
			$('#scoreamarillo').html('$' + numberWithCommas(scorenumamarillo));
			cambiaturnoAmarillo();
	...
	$('.myw').click(function(){
		datavaloramarillo = this.getAttribute('data-val-type');
		scorenumamarillo = parseInt(scorenumamarillo , 10) + parseInt(datavaloramarillo , 10);
		turno = 'amarillo';
		colore = 'amarillo';
	});
	$('.mvd').click(function(){
